...
| Extended Key Usage             | TLS Server Authentication, TLS Client Authentication                               |
| Certificate Policies           | CAB Forum Domain Validated (2.23.140.1.2.1)<br/>ISRG Domain Validated (1.3.6.1.4.1.44947.1.1.1)<br/>CPS Qualifier: Pointer to this CPS<br/>User Notice Qualifier: Message to potential relying parties |
| Authority Information Access   | Contains CA Issuers URL and OCSP URL. URLs vary based on Issuer.                   |
