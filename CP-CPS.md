...
Subscribers are not identified in DV certificates. Certificates do not assert any specific relationship between Subscribers and owners of domain names or IP addresses contained in certificates. Relying Parties should consider DV certificate Subscribers to be anonymous.
